...
<body>
   ...
   <!-- Ganti Audio di sini -->
   <audio src="https://feeldreams.github.io/djsayang.mp3" id="linkmp3" class="sembunyi"></audio>
   ...
   <div id='Content'>
     ...
     <div><blockquote id='bq' data-text='㋡'>
       <p id="kalimat">caca rahayu buka🥰</p>
       ...
       <!-- Pesan -->
       <p id="pesan3">selamat hapy weding🤣❤️</p>
       <p id="pesan4">Happy Birthday, </p>
       <p id="pesan5" class="gaya2">beki kolot mh ulah ngajar seblak wae</p>
       <p id="pesan6" class="gaya2">selamat ulang tahun caca cece rahayu astuti❤️ semoga sukses,mendapatkan jodoh meh kawin</p>
       <p id="pesan7" class="gaya2">Sehat selalu ya!</p>

       <p id="pesan8" class="gaya2">semoga kuliah na lancar amin😇:v</p>
       <p id="pesan9" class="gaya2">kade poho membangkang kedua orang tua,si sopian mendoakan selalu😇❤️</p>
